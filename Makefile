...
# students-epitech.ovh/autoscaling-tester-operator-bundle:$VERSION and students-epitech.ovh/autoscaling-tester-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= students-epitech.ovh/autoscaling-tester-operator
